...
<div
  style="text-align: center; background-color: #eee; padding: 10px; margin-bottom: 10px; color: green; font-size: 16px; font-weight: bold;">
...
<div
  style="text-align: center; background-color: #eee; padding: 10px; margin-bottom: 10px; color: red; font-size: 16px; font-weight: bold;">
...
<div class="prodBox"
  style="flex: 30%;text-decoration: none;margin: 5px;padding: 0px;border: none;background-color: white;padding: 5px;border: 1px solid #eeeeee;min-height: 100px;">

  <div style="display: flex; flex-direction: row;justify-content: flex-start;">
    <img src="<?= $arr_res[$i]["product_image"] ?>"
      style="max-width:100px;max-height:140px;margin-right: 10px;margin-left: 10px;" />
