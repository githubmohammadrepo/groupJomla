...
if (isset($_POST) && isset($_POST["lat"]) && isset($_POST["lng"])) {
  ...
  if ($contents && count($contents) > 0) {
    ...
    if ($contents[0]['id'] == "notok") {
      ...
      $url = "http://hypertester.ir/serverHypernetShowUnion/Sendto20Store.php";
...
$imagePath = "http://hypertester.ir/images/com_hikashop/upload/";
...
ikashop_product.product_id IN ({$ids})
